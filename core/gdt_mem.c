...
l_long gdt[GDT_ENTRIES] = {
	...
	// RING 3 (for now undefined)
	0x0000000000000000,	// + USERS_LIMIT, USERS_CODE sel. 0x38 ring 3
	0x0000000000000000, // + USERS_LIMIT, USERS_DATA sel. 0x40 ring 3
	/// System segment descriptors
	0x0000e90000000100, // TSS_CORE_SEL   sel. 0x48 ring 3
	0x0000e20000000100, // LDT_CORE_SEL   sel. 0x50 ring 3
	// RING 1 TASKS
	0x0000a90000000100, // TSS_DEVS_IRQ   sel. 0x58
	0x0000a20000000100, // LDT_DEVS_IRQ   sel. 0x60
	0x0000e90000000100, // TSS_DEVS_SCHED sel. 0x68
	0x0000e20000000100, // LDT_DEVS_SCHED sel. 0x70
	...
	0x0000000000000000, // TSS_USERS_IRQ 0x98
	0x0000000000000000, // LDT_USERS_IRQ 0xA0
