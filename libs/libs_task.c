...
extern void libss_sched_task(void);


void Levs_init(long * p_gdt);

l_long ldt_irq[2] =	{
	0x00c0ba0000000000 + LIBS_LIMIT,	// Sel. 0x05 LIBS_IRQ_CODE
	0x00c0b20000000000 + LIBS_LIMIT		// Sel. 0x0d LIBS_IRQ_DATA
};

l_long ldt_sched[2] = {
	0x00c0ba0000000000 + LIBS_LIMIT,	// Sel. 0x05 LIBS_SCHED_CODE
	0x00c0b20000000000 + LIBS_LIMIT		// Sel. 0x0d LIBS_SCHED_DATA
};
...
struct tss_struct tss_libs_irq = {
	...
	LIBS_IRQ_DATA, LIBS_ACCES_DATA,		// fs, gs
...
struct tss_struct tss_libs_sched = {
	...
	LIBS_SCHED_DATA, LIBS_ACCES_DATA,	// fs, gs
...
__naked void set_libs_tss_desc(void) {
__asm{
	add edi,ecx
	mov [edi+0x2], ax
	ror eax, 0x10
